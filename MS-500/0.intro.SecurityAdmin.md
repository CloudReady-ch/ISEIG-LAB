...
* Vidéo de présentation, très marketing, en anglais, mais donne un bn aperçu (14mn): https://www.microsoft.com/en-us/videoplayer/embed/RE4FGKd?autoplay=true
...
# Déroulement
## Support et LAB
* Le support de formation est fourni en mode électronique, sur https://www.skillpipe.com/ - il faut s'y créer un compte et activer le code fourni (par email)
* Le LAB pour les exercices est dans un Cloud: https://labs.xtremelabs.io/
...
* Il faut compter 4 jours en enseignement dirigé,
...
Rappel accès via son propre login sur https://labs.xtremelabs.io/. Le mot de passe de l'admin local sur le PC LAB est Pa55w.rd
