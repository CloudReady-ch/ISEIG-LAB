...
#### LAB
Contrairement aux LABs Foundation, le LAB Microsoft est utile pour récupérer par apprenant son propre tenant, avec les bonnes licences E5, en plus de 2 pc w10 et 1 DC.
...
* `Connect-AzureAD` pour établir une connexion depuis un poste client sur MSonline (365 tenant) via Powershell
