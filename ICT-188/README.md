...
* WARNING: les liens dans la version PDF peuvent être désactivés, et il vaut mieux alors utiliser le PPTX en lien ci-dessous (si explicitement affichés avec http:// Edge peut les réactiver articiellement)
### PPTX téléchargeable
...
# Annexes
## LAB Azure
* Activer le compte @edu.iseig.ch sur https://azure.microsoft.com/en-us/free/students/
