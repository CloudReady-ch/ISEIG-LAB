...
* Subscriptions and Accounts
  ...
  * https://docs.microsoft.com/en-us/azure/best-practices-availability-paired-regions#what-are-paired-regions
    ...
    * Region: Une ville avec au moins un datacentre (Exemple à utiliser car +fonctions, North Europe + West Europe), accès peut être limité.
    * Zone: Dans une régon (ville): au sein d'une région, multiple zone permet de faire du ZRS. (Zone Redondance) dans un seul, ou multiple datacentre.
* Azure Policy
