...
* adaptation: 1 seul CPU et 1GB RAM (lower cost & Free trial compatible): 
  * Ex.1,Task.1: Prendre le **server 2016 datacenter - server core**
  > Changer pour **Standard B1s** au lieu 
  > Task.2.point 7: changer $skuName=_2016-Datacenter_ pour **2016-Datacenter-Server-Core-smalldisk**
