# Préparations pour les LABs Microsoft - Module 01 & suivants
...
* adaptation: 1 seul CPU et 1GB RAM (lower cost & Free trial compatible): 
  * Ex-1.Task1: Prendre le **server 2016 datacenter - server core**
  > Changer pour **Standard B1s** au lieu **Standard\_DS2\_v2**
  * Task2.point7: 
...
* https://aka.ms/AB-AA4ecq5
  ...
  * Autre gag: Si on applique la suppression des ressources selon script inclus: Le serveur hébergant le service à supprimé, n'existe plus. Il faut alors le décommissionner pour faire le ménage.
