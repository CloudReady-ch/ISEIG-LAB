...
* Les LABs ne sont plus disponibles sur les supports initialement open source, toutefois, nous avons pris soin d'en faire un "fork" avant disparition
  * https://github.com/CloudReady-ch/AZ-900T0xFR-MicrosoftAzureFundamentals/tree/master/Instructions/Walkthroughs
  * Ils datent de 2022: Mais restent globalement d'actualité en 2024, à voir les degrés et vitesses d'obsolescences
  * Ils sont utilisable avec des comptes Azure étudiant gratuits (100$ par année)
  * **ATTENTION** de penser à supprimer les ressources (via le groupe de ressources contenant) après opération pour éviter épuisement rapide du crédit gratuit annuel.
