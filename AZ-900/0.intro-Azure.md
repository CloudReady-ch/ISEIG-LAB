...
Nous vous proposons d'utiliser le mode coaching ou colearning, avec l'ISEIG, via un espace pour faire vos LAB, avec accompagnateur pour exposer les aspects "théorique" et débloquer dans les Labs.
